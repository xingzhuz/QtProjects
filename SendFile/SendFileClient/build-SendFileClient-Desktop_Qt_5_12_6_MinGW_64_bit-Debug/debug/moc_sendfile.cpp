...
QT_MOC_LITERAL(3, 20, 8), // "gameOver"
QT_MOC_LITERAL(4, 29, 10), // "curPercent"
QT_MOC_LITERAL(5, 40, 3), // "num"
QT_MOC_LITERAL(6, 44, 12), // "sendFinished"
QT_MOC_LITERAL(7, 57, 11) // "closeSocket"

    },
    "SendFile\0connectOK\0\0gameOver\0curPercent\0"
    "num\0sendFinished\0closeSocket"
};
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->curPercent((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->sendFinished(); break;
        ...
        {
            using _t = void (SendFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::gameOver)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::curPercent)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SendFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::sendFinished)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void SendFile::curPercent(int _t1)
{
